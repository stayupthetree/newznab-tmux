...
RUN apt-get -q update && \
    ...
    apt-get -q update && \
    apt-get install -qy apache2 libapache2-mod-php7.4 php-pear php7.4 php7.4-cli php7.4-dev php7.4-common php7.4-curl php7.4-json php7.4-gd php7.4-mysql php7.4-mbstring php7.4-xml php7.4-intl php7.4-fpm php7.4-bcmath php7.4-zip php-imagick
