...
sudo -E -u www-data php /var/www/NNTmux/misc/manticoresearch/create_se_tables.php $SPHINX_HOST 9312
sudo -E -u www-data php /var/www/NNTmux/misc/manticoresearch/populate_rt_indexes.php releases_rt
sudo -E -u www-data php /var/www/NNTmux/misc/manticoresearch/populate_rt_indexes.php predb_rt
